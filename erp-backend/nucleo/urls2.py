...
from .api import (
    ...
    ProveedorListCreateAPIView, ProveedorUpdateAPIView, ProveedorDetalleHistorialAPIView, RegistrarAbonoCxPAPIView,
    RegistrarAbonoCxPAPIView,
    ConceptoEgresoListAPIView,         # <-- NUEVO
    RegistrarEgresoCajaAPIView,        # <-- NUEVO
    RegistrarEgresoInventarioAPIView,   # <-- NUEVO
...
urlpatterns = [
    ...
    path('api/v1/clientes/<int:pk>/editar/', ClienteUpdateAPIView.as_view(), name='api_cliente_editar'),    path('api/v1/compras/registrar/', ProcesarCompraAPIView.as_view(), name='api_registrar_compra'),
