...
from .api import (
    ...
    DetalleVentaFacturaAPIView # <--- AQUÍ ESTÁ LA IMPORTACIÓN QUE FALTABA
)
...
urlpatterns = [
    ...
    path('api/v1/ventas/<int:pk>/detalle/', DetalleVentaFacturaAPIView.as_view(), name='api_venta_detalle'), # <--- NUEVA RUTA
