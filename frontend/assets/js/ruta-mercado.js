    ...
    try {
        ...
        let html = `
            <div class="row mb-3">
                ...
                <div class="col-md-6"><strong>Tasa:</strong> ${monedaSecundaria} ${tasa.toFixed(2)}</div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        }).join('') || '<li class="list-group-item py-1 text-muted">Sin gastos</li>'}
                    </ul>
                </div>
            </div>
            <hr>
            <div class="row text-center fw-bold">
                <div class="col">
                    Venta: <span class="text-primary">$ ${ventaUSD.toFixed(2)}</span>
                    <br><small class="text-muted">${monedaSecundaria} ${ventaBS.toFixed(2)}</small>
                </div>
                <div class="col">
